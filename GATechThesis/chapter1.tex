...
reconstructing the Fock matrix until convergence. The most compuatationally demanding operation for this
method is by far the evaluating of the Coulomb and exchange matrices. 
